...
Gem::Specification.new do |s|
  ...
  s.files = [%q{Gemfile}, %q{Gemfile.lock}, %q{Manifest}, %q{Rakefile}, %q{bin/cron_wrapper}, %q{cron_wrapper.gemspec}, %q{lib/cron/awesome_script.rb}, %q{lib/cron_wrapper.rb}, %q{spec/cron_wrapper_spec.rb}, %q{spec/spec_helper.rb}]
